...
class UsuarioDAOImpl implements UsuarioDAO {
    ...
    public Usuario buscaUsuarioPorId(final int id)
        ...
        try {
            ...
            sbSelect.append(UsuarioDAOConstantes.USUARIO_TABLE_NAME);
    ...
    public void removeUsuario(final int id)
        ...
        try {
            ...
            sbDelete.append(UsuarioDAOConstantes.USUARIO_TABLE_NAME);
    ...
    public Usuario criaUsuario(
        ...
        try {
            ...
            sbInsert.append(UsuarioDAOConstantes.USUARIO_TABLE_NAME);
            sbInsert.append(" ( usuario_id, nome, sobrenome ) ");
            sbInsert.append(" VALUES (");
            sbInsert.append(" NEXT VALUE FOR ");
            sbInsert.append(UsuarioDAOConstantes.USUARIO_ID_SEQUENCE_NAME);
            sbInsert.append(", ?, ?) ");
    ...
    public void updateUsuario(final int id,
        ...
        try {
            ...
            sbUpdate.append(UsuarioDAOConstantes.USUARIO_TABLE_NAME);
            sbUpdate.append(" SET ");
